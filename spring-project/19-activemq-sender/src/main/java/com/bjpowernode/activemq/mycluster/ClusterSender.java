package com.bjpowernode.activemq.mycluster;
...
public class ClusterSender {
    ...
    private static void send() {
        ...
        try {
            ...
            ConnectionFactory connectionFactory=new ActiveMQConnectionFactory("failover:(tcp://192.168.31.128:61617,tcp://192.168.31.128:61618,tcp://192.168.31.128:61619)");
            //2.创建连接对象
            ...
            for(long i=0;;i++){
                ...
                System.out.println("消息发送完成queue的测试"+i);
            }
